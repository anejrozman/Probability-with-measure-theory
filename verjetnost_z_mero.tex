...
\section{Mera}
    \subsection{Merljivost in mere}
        ...
        \subsubsection{Merjlive preslikave in generirane $\sigma$-algebre}
            ...
            \begin{zgled}
                Naj bosta $\{E, F\} \subset 2^\Omega.$ Potem mora $\sigma_\Omega(\{E, F\})$ vsebovati $\{\emptyset, E, F, E\emptyset F, E \cap F, \cdots\}$ oziroma tako imenovano particijo $\mathcal{P} := \{E \cap \}$
            \end{zgled}
\end{document}